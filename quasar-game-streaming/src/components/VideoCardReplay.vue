    ...
    <q-card class="my-card cursor-pointer">
      ...
      <div class="q-px-sm q-pb-sm">
        <div class="text-h6 text-hover ellipsis">
          ...
          culpa molestiae ex veniam suscipit quo sapiente fuga. Et enim porro
          eveniet, quibusdam impedit ratione nam aliquam officia deleniti esse.
        </div>
  ...
  <div v-else>
    <q-responsive :ratio="16 / 13">
      <q-card class="cursor-pointer column">
        ...
        <q-card-section class="no-wrap q-px-sm q-py-none q-pb-sm column">
          <q-skeleton
            square
            width="100%"
