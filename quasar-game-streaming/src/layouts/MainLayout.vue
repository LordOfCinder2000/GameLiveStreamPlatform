      ...
      <q-toolbar>
        ...
        >
          ...
          >
            ...
            <label class="gt-md q-pl-sm cursor-inherit">Phân loại </label>
            <q-icon
        ...
        <div class="overflow-hidden">
          <div class="q-gutter-x-sm row no-wrap items-center">
            ...
            <q-btn
              ...
              padding="sm"
            />
            <q-btn class="gt-md" no-caps flat icon="favorite" padding="sm" />
            <q-btn class="gt-md" no-caps flat icon="history" padding="sm" />
            <q-btn class="gt-md" no-caps flat icon="get_app" padding="sm" />
            <q-btn class="lt-lg" no-caps flat icon="more_horiz" padding="sm" />
            <q-btn no-wrap no-caps outline color="positive" label="Đăng ký" />
            <q-btn no-wrap no-caps color="positive" label="Đăng nhập" />
          </div>
        </div>
      </q-toolbar>
    </q-header>
      ...
      <div class="column full-height items-center">
        <div class="overflow-auto">
          <div class="col q-pt-lg q-gutter-x-lg">
            <q-btn padding="xs" flat size="xl" icon="mdi-facebook" />
            <q-btn padding="xs" flat size="xl" icon="mdi-youtube" />
            <q-btn padding="xs" flat size="xl" icon="mdi-twitter" />
            <q-btn padding="xs" flat size="xl" icon="mdi-instagram" />
          </div>
        </div>
        <div class="col-4"></div>
        <div class="col-auto">
          <p>
            Copyright &copy; {{ new Date().getFullYear() }} Huya PTE. LTD. All
            Rights Reserved
          </p>
        </div>
      </div>
