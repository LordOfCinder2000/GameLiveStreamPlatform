...
var oidc = (() => {
	...
	var re = (l, e) => () => (
		...
		st = (l, e) => {
			for (var t in e) ae(l, t, { get: e[t], enumerable: !0 });
		},
		Me = (l, e, t, r) => {
			if ((e && typeof e == "object") || typeof e == "function")
				for (let i of tt(e))
					!it.call(l, i) &&
						...
						ae(l, i, {
							get: () => e[i],
							enumerable: !(r = et(e, i)) || r.enumerable,
						});
			return l;
		};
	var ce = (l, e, t) => (
			...
			Me(
				e || !l || !l.__esModule
					? ae(t, "default", { value: l, enumerable: !0 })
					: t,
				l
			)
		),
		nt = (l) => Me(ae({}, "__esModule", { value: !0 }), l);
	var qe = re(() => {});
	var ie = re((le, Ne) => {
		(function (l, e) {
			typeof le == "object"
				...
				(function (e, t) {
					...
					var i = function () {
						...
						u = (o.WordArray = c.extend({
							...
							random: function (a) {
								for (var g = [], w = 0; w < a; w += 4)
									g.push(i());
								return new u.init(g, a);
							},
						})),
						m = (n.enc = {}),
						h = (m.Hex = {
							stringify: function (a) {
								for (
									...
									var S =
										(g[v >>> 2] >>> (24 - (v % 4) * 8)) &
										255;
									b.push((S >>> 4).toString(16)),
										b.push((S & 15).toString(16));
								}
								return b.join("");
							},
							parse: function (a) {
								for (
									var g = a.length, w = [], b = 0;
									b < g;
									b += 2
								)
									w[b >>> 3] |=
						...
						_ = (o.BufferedBlockAlgorithm = c.extend({
							...
							_process: function (a) {
								...
								if (C) {
									...
									(g = b.splice(0, C)), (w.sigBytes -= F);
								}
								return new u.init(g, F);
							},
							clone: function () {
								var a = c.clone.call(this);
						...
						k = (o.Hasher = _.extend({
							...
							_createHelper: function (a) {
								return function (g, w) {
									return new a.init(w).finalize(g);
								};
							},
							_createHmacHelper: function (a) {
								return function (g, w) {
									return new y.HMAC.init(a, w).finalize(g);
								};
							},
						})),
						y = (n.algo = {});
		...
		(function (l, e) {
			...
			return (
				(function (e) {
					...
					(t.SHA256 = s._createHelper(m)),
						(t.HmacSHA256 = s._createHmacHelper(m));
				})(Math),
				l.SHA256
			);
		});
		...
		(function (l, e) {
			...
			return (
				(function () {
					...
					function n(o, c, u) {
						for (var m = [], h = 0, p = 0; p < c; p++)
							if (p % 4) {
								var f = u[o.charCodeAt(p - 1)] << ((p % 4) * 2),
									_ =
										u[o.charCodeAt(p)] >>>
										(6 - (p % 4) * 2),
									k = f | _;
	...
	st(vt, {
		...
		ErrorResponse: () => U,
		ErrorTimeout: () => M,
		InMemoryWebStorage: () => W,
		Log: () => J,
		Logger: () => d,
		MetadataService: () => G,
		OidcClient: () => ne,
		OidcClientSettingsStore: () => H,
		SessionMonitor: () => Z,
		SigninResponse: () => $,
		SigninState: () => q,
		SignoutResponse: () => X,
	...
	var d = class {
		...
		debug(...e) {
			A >= 4 && O.debug(d._format(this._name, this._method), ...e);
		}
		info(...e) {
			A >= 3 && O.info(d._format(this._name, this._method), ...e);
		}
		warn(...e) {
			A >= 2 && O.warn(d._format(this._name, this._method), ...e);
		}
		error(...e) {
			A >= 1 && O.error(d._format(this._name, this._method), ...e);
		}
		throw(e) {
		...
		static debug(e, ...t) {
			A >= 4 && O.debug(d._format(e), ...t);
		}
		static info(e, ...t) {
			A >= 3 && O.info(d._format(e), ...t);
		}
		static warn(e, ...t) {
			A >= 2 && O.warn(d._format(e), ...t);
		}
		static error(e, ...t) {
			A >= 1 && O.error(d._format(e), ...t);
		}
	};
	J.reset();
	var at = "10000000-1000-4000-8000-100000000000",
		I = class {
			static _randomWord() {
				return Je.default.lib.WordArray.random(1).words[0];
			}
			...
			static generateCodeVerifier() {
				return (
					I.generateUUIDv4() + I.generateUUIDv4() + I.generateUUIDv4()
				);
			}
			static generateCodeChallenge(e) {
				try {
					...
					throw (d.error("CryptoUtils.generateCodeChallenge", t), t);
				}
			}
			static generateBasicAuth(e, t) {
				let r = Ke.default.parse([e, t].join(":"));
				return Re.default.stringify(r);
			}
		};
	var T = class {
		constructor(e) {
			this._name = e;
			this._logger = new d(`Event('${this._name}')`);
			this._callbacks = [];
		}
		addHandler(e) {
		...
		function (l) {
			...
			for (
				...
				~r && ((t = i % 4 ? 64 * t + r : r), i++ % 4)
					? (n += String.fromCharCode(255 & (t >> ((-2 * i) & 6))))
					: 0
			)
				r =
	...
	function lt(l, e) {
		if (typeof l != "string") throw new pe("Invalid token specified");
		var t = (e = e || {}).header === !0 ? 0 : 1;
		try {
			return JSON.parse(ct(l.split(".")[t]));
		} catch (r) {
	...
	var D = class {
		static decode(e) {
			try {
				...
				throw (d.error("JwtUtils.decode", t), t);
			}
		}
	};
	var se = class {
			...
			return (
				...
				(r = e.left) != null ||
					(e.left = Math.max(
						0,
						Math.round(
							window.screenX + (window.outerWidth - e.width) / 2
						)
					)),
				e.height != null &&
					((i = e.top) != null ||
	...
	var P = class extends T {
		constructor() {
			super(...arguments);
			this._logger = new d(`Timer('${this._name}')`);
			this._timerHandle = null;
			this._expiration = 0;
			this._callback = () => {
				let t = this._expiration - P.getEpochTime();
				this._logger.debug("timer completes in", t),
					this._expiration <= P.getEpochTime() &&
	...
	var U = class extends Error {
		constructor(t, r) {
			...
			if (!t.error)
				throw (
					(d.error("ErrorResponse", "No error passed"),
					new Error("No error passed"))
				);
			(this.error = t.error),
				(this.error_description =
					(i = t.error_description) != null ? i : null),
				(this.error_uri = (s = t.error_uri) != null ? s : null),
	...
	var Q = class {
		constructor(e) {
			this._logger = new d("AccessTokenEvents");
			this._expiringTimer = new P("Access token expiring");
			this._expiredTimer = new P("Access token expired");
		...
		load(e) {
			...
			if (e.access_token && e.expires_in !== void 0) {
				let r = e.expires_in;
				if (
					(t.debug("access token present, remaining duration:", r),
					r > 0)
				) {
	...
	var V = class {
		constructor(e, t, r, i, s) {
			...
			this._stopOnError = s;
			this._logger = new d("CheckSessionIFrame");
			this._timer = null;
	...
	var W = class {
		constructor() {
			this._logger = new d("InMemoryWebStorage");
			this._data = {};
		}
		clear() {
	...
	var L = class {
		constructor(e = [], t = null) {
			this._jwtHandler = t;
			this._logger = new d("JsonService");
			this._contentTypes = [];
		...
		async fetchWithTimeout(e, t = {}) {
			...
			let s = new AbortController(),
				n = setTimeout(() => s.abort(), r * 1e3);
			try {
				return await fetch(e, { ...t, signal: s.signal });
			} catch (o) {
				throw o instanceof DOMException && o.name === "AbortError"
					? new M("Network timed out")
					: o;
			} finally {
				clearTimeout(n);
			}
		}
		async getJson(e, { token: t } = {}) {
			let r = this._logger.create("getJson"),
				i = { Accept: this._contentTypes.join(", ") };
			t &&
				(r.debug("token passed, setting Authorization header"),
			...
			let n = s.headers.get("Content-Type");
			if (
				(n &&
					!this._contentTypes.find((c) => n.startsWith(c)) &&
					r.throw(
						new Error(
				...
				s.ok &&
					this._jwtHandler &&
					(n == null ? void 0 : n.startsWith("application/jwt")))
			)
			...
			try {
				...
				throw (
					(r.error("Error parsing JSON response", c),
					s.ok ? c : new Error(`${s.statusText} (${s.status})`))
				);
			}
			if (!s.ok)
				throw (
					(r.error("Error from server:", o),
					o.error
						? new U(o)
						: new Error(
								`${s.statusText} (${
		...
		async postForm(e, { body: t, basicAuth: r, timeoutInSeconds: i }) {
			let s = this._logger.create("postForm"),
				n = {
					Accept: this._contentTypes.join(", "),
					"Content-Type": "application/x-www-form-urlencoded",
				};
			r !== void 0 && (n.Authorization = "Basic " + r);
			let o;
			try {
				s.debug("url:", e),
					(o = await this.fetchWithTimeout(e, {
						method: "POST",
						headers: n,
						body: t,
						timeoutInSeconds: i,
			...
			if (u)
				try {
					...
					throw (
						(s.error("Error parsing JSON response", h),
						o.ok ? h : new Error(`${o.statusText} (${o.status})`))
					);
				}
			if (!o.ok)
				throw (
					(s.error("Error from server:", m),
					m.error
						? new U(m, t)
						: new Error(
								`${o.statusText} (${
	...
	var G = class {
		constructor(e) {
			this._settings = e;
			this._logger = new d("MetadataService");
			this._jsonService = new L(["application/jwk-set+json"]);
		...
		async getSigningKeys() {
			...
			if (this._signingKeys)
				return (
					e.debug("returning signingKeys from cache"),
					this._signingKeys
				);
	...
	var j = class {
		constructor({ prefix: e = "oidc.", store: t = localStorage } = {}) {
			this._logger = new d("WebStorageStateStore");
	...
	var dt = "code",
		...
		H = class {
			constructor({
				...
				resource: g,
				response_mode: w = pt,
				filterProtocolClaims: b = !0,
				loadUserInfo: v = !1,
				staleStateAgeInSeconds: S = ht,
				clockSkewInSeconds: R = ft,
				userInfoJwtIssuer: x = "OP",
				mergeClaims: C = !1,
				stateStore: F,
				extraQueryParams: B = {},
				extraTokenParams: xe = {},
				...
				if (
					...
					(this.scope = u),
					(this.redirect_uri = m),
					(this.post_logout_redirect_uri = h),
					...
					(this.acr_values = a),
					(this.resource = g),
					(this.response_mode = w),
					(this.filterProtocolClaims = !!b),
					(this.loadUserInfo = !!v),
					(this.staleStateAgeInSeconds = S),
					(this.clockSkewInSeconds = R),
					(this.userInfoJwtIssuer = x),
					(this.mergeClaims = !!C),
					F)
				)
					this.stateStore = F;
					...
					let Pe =
						typeof window != "undefined"
							? window.localStorage
							: new W();
					this.stateStore = new j({ store: Pe });
				}
				(this.extraQueryParams = B), (this.extraTokenParams = xe);
			}
		};
	var he = class {
		constructor(e) {
			this._metadataService = e;
			this._logger = new d("UserInfoService");
			...
			this._jsonService = new L(void 0, this._getClaimsFromJwt);
		}
		async getClaims(e) {
			...
			let i = await this._jsonService.getJson(r, { token: e });
	...
	var Y = class {
		constructor(e, t) {
			...
			this._logger = new d("TokenClient");
			this._jsonService = new L();
		}
		async exchangeCode({
			...
			let n = this._logger.create("exchangeCode");
			r || n.throw(new Error("A client_id is required")),
				t || n.throw(new Error("A redirect_uri is required")),
				s.code || n.throw(new Error("A code is required")),
				s.code_verifier ||
					n.throw(new Error("A code_verifier is required"));
			let o = new URLSearchParams({ grant_type: e, redirect_uri: t });
			for (let [h, p] of Object.entries(s)) p != null && o.set(h, p);
			let c;
			switch (this._settings.client_authentication) {
				case "client_secret_basic":
					if (!i)
						throw (
							(n.throw(new Error("A client_secret is required")),
							null)
						);
			...
			let u = await this._metadataService.getTokenEndpoint(!1);
			n.debug("got token endpoint");
			let m = await this._jsonService.postForm(u, {
				body: o,
				basicAuth: c,
			});
			return n.debug("got response"), m;
		}
		async exchangeRefreshToken({
			...
			let n = this._logger.create("exchangeRefreshToken");
			t || n.throw(new Error("A client_id is required")),
				s.refresh_token ||
					n.throw(new Error("A refresh_token is required"));
		...
		async revoke(e) {
			...
			t.debug(
				`got revocation endpoint, revoking ${
					(s = e.token_type_hint) != null ? s : "default token type"
				}`
			);
			let i = new URLSearchParams();
			for (let [n, o] of Object.entries(e)) o != null && i.set(n, o);
	...
	var mt = [
		...
		fe = class {
			constructor(e, t) {
				this._settings = e;
				this._metadataService = t;
				this._logger = new d("ResponseValidator");
				this._userInfoService = new he(this._metadataService);
				this._tokenClient = new Y(
					this._settings,
			...
			async validateRefreshResponse(e, t) {
				...
				(e.userState = t.data),
					(s = e.session_state) != null ||
						(e.session_state = t.session_state),
				...
				i &&
					...
					await this._processClaims(e, !1, i),
					r.debug("claims processed");
			}
			validateSignoutResponse(e, t) {
				...
				if (
					(t.id !== e.state &&
						r.throw(new Error("State does not match")),
					r.debug("state validated"),
					(e.userState = t.data),
					e.error)
				)
					throw (r.warn("Response was error", e.error), new U(e));
			}
			_processSigninState(e, t) {
				...
				t.code_verifier &&
					...
					!t.code_verifier &&
						e.code &&
						r.throw(new Error("Unexpected code in response"));
			}
			async _processClaims(e, t = !1, r = !0) {
				...
				let s = await this._userInfoService.getClaims(e.access_token);
				i.debug("user info claims received from user info endpoint"),
					...
					(e.profile = this._mergeClaims(
						e.profile,
						this._filterProtocolClaims(s)
					)),
					i.debug(
			...
			_mergeClaims(e, t) {
				...
				for (let [i, s] of Object.entries(t))
					for (let n of Array.isArray(s) ? s : [s]) {
						let o = r[i];
						o
							? Array.isArray(o)
			...
			_validateIdTokenAttributes(e, t) {
				...
				let i = D.decode((s = e.id_token) != null ? s : "");
				if (
					(i.sub ||
						r.throw(
							new Error("ID Token is missing a subject claim")
						),
					t)
				) {
					let n = D.decode(t);
	...
	var E = class {
		constructor(e) {
			(this.id = e.id || I.generateUUIDv4()),
				...
				e.created && e.created > 0
					...
					: (this.created = P.getEpochTime()),
				(this.request_type = e.request_type);
		}
		toStorageString() {
			return (
				new d("State").create("toStorageString"),
				JSON.stringify({
					id: this.id,
					data: this.data,
		...
		static fromStorageString(e) {
			return (
				d.createStatic("State", "fromStorageString"),
				new E(JSON.parse(e))
			);
		}
		static async clearStaleState(e, t) {
			let r = d.createStatic("State", "clearStaleState"),
				i = P.getEpochTime() - t,
				s = await e.getAllKeys();
			r.debug("got keys", s);
			for (let n = 0; n < s.length; n++) {
				...
				if (c)
					try {
						let m = E.fromStorageString(c);
						r.debug("got item from key:", o, m.created),
							m.created <= i && (u = !0);
					} catch (m) {
						r.error("Error parsing state for key:", o, m), (u = !0);
					}
				else r.debug("no item in storage for key:", o), (u = !0);
	...
	var q = class extends E {
		constructor(t) {
			...
			t.code_verifier === !0
				...
				this.code_verifier &&
					(this.code_challenge = I.generateCodeChallenge(
						this.code_verifier
					)),
		...
		toStorageString() {
			return (
				new d("SigninState").create("toStorageString"),
				JSON.stringify({
					id: this.id,
					data: this.data,
					created: this.created,
		...
		static fromStorageString(t) {
			d.createStatic("SigninState", "fromStorageString");
			let r = JSON.parse(t);
			return new q(r);
		}
	};
	var me = class {
		constructor({
			...
			this._logger = new d("SigninRequest");
			if (!e)
				throw (
			...
			let y = new URL(e);
			y.searchParams.append("client_id", r),
				y.searchParams.append("redirect_uri", i),
				y.searchParams.append("response_type", s),
				y.searchParams.append("scope", n),
				h && y.searchParams.append("nonce", h),
				y.searchParams.append("state", this.state.id),
				this.state.code_challenge &&
					(y.searchParams.append(
						"code_challenge",
						this.state.code_challenge
					),
					y.searchParams.append("code_challenge_method", "S256"));
			for (let [a, g] of Object.entries({ response_mode: c, ...k, ...f }))
				g != null && y.searchParams.append(a, g.toString());
			this.url = y.href;
		}
	};
	var _t = "openid",
		$ = class {
			...
			set expires_in(e) {
				typeof e == "string" && (e = Number(e)),
					e !== void 0 &&
						e >= 0 &&
						(this.expires_at = Math.floor(e) + P.getEpochTime());
			}
			get isOpenId() {
				var e;
				return (
					((e = this.scope) == null
						? void 0
						: e.split(" ").includes(_t)) || !!this.id_token
				);
			}
		};
	var _e = class {
		constructor({
			...
			this._logger = new d("SignoutRequest");
			if (!e)
				throw (
					(this._logger.error("ctor: No url passed"),
					new Error("url"))
			...
			let o = new URL(e);
			r && o.searchParams.append("id_token_hint", r),
				i &&
					(o.searchParams.append("post_logout_redirect_uri", i),
					t &&
						((this.state = new E({ data: t, request_type: n })),
						o.searchParams.append("state", this.state.id)));
			for (let [c, u] of Object.entries({ ...s }))
				u != null && o.searchParams.append(c, u.toString());
			this.url = o.href;
		}
	};
	var X = class {
	...
	var ne = class {
		constructor(e) {
			this._logger = new d("OidcClient");
			(this.settings = new H(e)),
				(this.metadataService = new G(this.settings)),
				(this._validator = new fe(this.settings, this.metadataService)),
				(this._tokenClient = new Y(
					this.settings,
		...
		async createSigninRequest({
			...
			acr_values: y = this.settings.acr_values,
			resource: a = this.settings.resource,
			response_mode: g = this.settings.response_mode,
			...
			let S = await this.metadataService.getAuthorizationEndpoint();
			v.debug("Received authorization endpoint", S);
			let R = new me({
				url: S,
			...
			let x = R.state;
			return (
				await this.settings.stateStore.set(x.id, x.toStorageString()), R
			);
		}
		async readSigninResponseState(e, t = !1) {
			let r = this._logger.create("readSigninResponseState"),
				i = new $(K.readParams(e, this.settings.response_mode));
			if (!i.state)
				throw (r.throw(new Error("No state in response")), null);
			let s = await this.settings.stateStore[t ? "remove" : "get"](
				i.state
			);
			if (!s)
				throw (
					(r.throw(new Error("No matching state found in storage")),
					null)
				);
			return { state: q.fromStorageString(s), response: i };
		}
		async processSigninResponse(e) {
			let t = this._logger.create("processSigninResponse"),
				{ state: r, response: i } = await this.readSigninResponseState(
					e,
					!0
				);
			return (
		...
		async useRefreshToken({ state: e, timeoutInSeconds: t }) {
			let r = this._logger.create("useRefreshToken"),
				i = await this._tokenClient.exchangeRefreshToken({
					refresh_token: e.refresh_token,
					scope: e.scope,
					timeoutInSeconds: t,
				}),
				s = new $(new URLSearchParams());
			return (
				Object.assign(s, i),
				r.debug("validating response", s),
				await this._validator.validateRefreshResponse(s, e),
				s
			);
		}
		async createSignoutRequest({
			...
			id_token_hint: t,
			request_type: r,
			post_logout_redirect_uri: i = this.settings
				.post_logout_redirect_uri,
			extraQueryParams: s = this.settings.extraQueryParams,
		} = {}) {
			let n = this._logger.create("createSignoutRequest"),
				o = await this.metadataService.getEndSessionEndpoint();
			if (!o) throw (n.throw(new Error("No end session endpoint")), null);
			...
			return (
				u &&
					(n.debug("Signout request has state to persist"),
		...
		async readSignoutResponseState(e, t = !1) {
			let r = this._logger.create("readSignoutResponseState"),
				i = new X(K.readParams(e, this.settings.response_mode));
			if (!i.state) {
				if ((r.debug("No state in response"), i.error))
					throw (r.warn("Response was error:", i.error), new U(i));
			...
			return { state: E.fromStorageString(s), response: i };
		}
		async processSignoutResponse(e) {
			let t = this._logger.create("processSignoutResponse"),
				{ state: r, response: i } = await this.readSignoutResponseState(
					e,
					!0
				);
			return (
	...
	var Z = class {
		constructor(e) {
			this._userManager = e;
			this._logger = new d("SessionMonitor");
			this._start = async (e) => {
				...
				try {
					...
					if (i) {
						...
						let s = this._userManager.settings.client_id,
							...
							c = new V(this._callback, s, i, n, o);
						await c.load(),
			...
			if (e) this._start(e);
				...
				if (t) {
					let r = {
						...
						profile:
							t.sub && t.sid ? { sub: t.sub, sid: t.sid } : null,
					};
					this._start(r);
				}
			}
	...
	var N = class {
		...
		get scopes() {
			var e, t;
			return (t = (e = this.scope) == null ? void 0 : e.split(" ")) !=
				null
				? t
				: [];
		}
		toStorageString() {
			return (
				new d("User").create("toStorageString"),
				JSON.stringify({
		...
		static fromStorageString(e) {
			return (
				d.createStatic("User", "fromStorageString"),
				new N(JSON.parse(e))
			);
		}
	};
	var Qe = "oidc-client",
		ee = class {
			constructor() {
				this._abort = new T("Window navigation aborted");
			...
			async navigate(e) {
				...
				if (!this._window)
					throw new Error(
						"Attempted to navigate on a disposed window"
					);
				t.debug("setting URL in window"),
					this._window.location.replace(e.url);
				let { url: r, keepOpen: i } = await new Promise((s, n) => {
					let o = (c) => {
						var h;
						let u = c.data,
							m =
								(h = e.scriptOrigin) != null
									? h
									: window.location.origin;
						if (
							!(
								c.origin !== m ||
								(u == null ? void 0 : u.source) !== Qe
							)
						) {
							try {
								let p = K.readParams(
			...
			static _notifyParent(e, t, r = !1, i = window.location.origin) {
				e.postMessage({ source: Qe, url: t, keepOpen: r }, i);
			}
		};
	var Ue = { location: !1, toolbar: !1, height: 640 },
		Ce = "_blank",
		wt = 60,
		bt = 2,
		Ee = 10,
			...
			constructor(t) {
				let {
					...
					popup_post_logout_redirect_uri:
						i = t.post_logout_redirect_uri,
					popupWindowFeatures: s = Ue,
					popupWindowTarget: n = Ce,
					redirectMethod: o = "assign",
					redirectTarget: c = "self",
					iframeNotifyParentOrigin: u = t.iframeNotifyParentOrigin,
					iframeScriptOrigin: m = t.iframeScriptOrigin,
					silent_redirect_uri: h = t.redirect_uri,
					silentRequestTimeoutInSeconds: p = Ee,
					automaticSilentRenew: f = !0,
					validateSubOnSilentRenew: _ = !0,
					includeIdTokenInSilentRenew: k = !1,
					monitorSession: y = !1,
					monitorAnonymousSession: a = !1,
					checkSessionIntervalInSeconds: g = bt,
					query_status_response_type: w = "code",
					stopCheckSessionOnError: b = !0,
					revokeTokenTypes: v = ["access_token", "refresh_token"],
					revokeTokensOnSignout: S = !1,
					accessTokenExpiringNotificationTimeInSeconds: R = wt,
					userStore: x,
				} = t;
				super(t);
				if (
					...
					(this.popupWindowFeatures = s),
					(this.popupWindowTarget = n),
					(this.redirectMethod = o),
					(this.redirectTarget = c),
					(this.iframeNotifyParentOrigin = u),
					(this.iframeScriptOrigin = m),
					(this.silent_redirect_uri = h),
					(this.silentRequestTimeoutInSeconds = p),
					(this.automaticSilentRenew = f),
					(this.validateSubOnSilentRenew = _),
					(this.includeIdTokenInSilentRenew = k),
					(this.monitorSession = y),
					(this.monitorAnonymousSession = a),
					(this.checkSessionIntervalInSeconds = g),
					(this.stopCheckSessionOnError = b),
					...
					let C =
						typeof window != "undefined"
							...
							: new W();
					this.userStore = new j({ store: C });
				}
			}
		};
	var z = class extends ee {
		constructor({ silentRequestTimeoutInSeconds: t = Ee }) {
			super();
			this._logger = new d("IFrameWindow");
		...
		async navigate(t) {
			...
			let r = setTimeout(
				() =>
					this._abort.raise(
						new M("IFrame timed out without a response")
					),
					...
					(this._frame.addEventListener(
						...
						(r) => {
							...
							(s = i.parentNode) == null || s.removeChild(i),
								this._abort.raise(
									new Error("IFrame removed from DOM")
								);
						},
						!0
					),
	...
	var we = class {
		constructor(e) {
			this._settings = e;
			this._logger = new d("IFrameNavigator");
		}
		async prepare({
	...
	var St = 500,
		oe = class extends ee {
			constructor({
				...
				super();
				this._logger = new d("PopupWindow");
				let i = se.center({ ...Ue, ...r });
				this._window = window.open(void 0, t, se.serialize(i));
			}
			async navigate(t) {
				var i;
	...
	var be = class {
		constructor(e) {
			this._settings = e;
			this._logger = new d("PopupNavigator");
		}
		async prepare({
	...
	var Se = class {
		constructor(e) {
			this._settings = e;
			this._logger = new d("RedirectNavigator");
		}
		async prepare({
			...
			let r = window.self;
			t === "top" && (r = (n = window.top) != null ? n : window.self);
			let i = r.location[e].bind(r.location),
				s;
			return {
				navigate: async (o) => {
					this._logger.create("navigate");
					let c = new Promise((u, m) => {
						s = m;
					});
				...
				close: () => {
					this._logger.create("close"),
						s == null || s(new Error("Redirect aborted")),
						r.stop();
				},
			};
		}
	...
	var ye = class extends Q {
		constructor(t) {
			...
			this._logger = new d("UserManagerEvents");
			this._userLoaded = new T("User loaded");
			this._userUnloaded = new T("User unloaded");
			this._silentRenewError = new T("Silent renew error");
			this._userSignedIn = new T("User signed in");
			this._userSignedOut = new T("User signed out");
			this._userSessionChanged = new T("User session changed");
		}
		load(t, r = !0) {
	...
	var ve = class {
		constructor(e) {
			this._userManager = e;
			this._logger = new d("SilentRenewService");
			this._isStarted = !1;
			this._retryTimer = new P("Retry Silent Renew");
	...
	var Te = class {
		constructor(e) {
			this._logger = new d("UserManager");
			(this.settings = new te(e)),
				(this._client = new ne(e)),
				(this._redirectNavigator = new Se(this.settings)),
				(this._popupNavigator = new be(this.settings)),
				(this._iframeNavigator = new we(this.settings)),
				(this._events = new ye(this.settings)),
				(this._silentRenewService = new ve(this)),
				this.settings.automaticSilentRenew && this.startSilentRenew(),
				(this._sessionMonitor = null),
				this.settings.monitorSession &&
					(this._sessionMonitor = new Z(this));
		}
		get events() {
			return this._events;
		}
		...
		async signinRedirect(e = {}) {
			...
			let { redirectMethod: t, ...r } = e,
				i = await this._redirectNavigator.prepare({
					redirectMethod: t,
				});
		...
		async signinPopup(e = {}) {
			let t = this._logger.create("signinPopup"),
				{ popupWindowFeatures: r, popupWindowTarget: i, ...s } = e,
		...
		async signinSilent(e = {}) {
			...
			if (s != null && s.refresh_token) {
				...
				let m = new ke(s);
				return await this._useRefreshToken(m);
			}
			let n = this.settings.silent_redirect_uri;
			...
			s &&
				...
				(o = s.profile.sub));
			let c = await this._iframeNavigator.prepare({
		...
		async querySessionStatus(e = {}) {
			...
			let n = await this._iframeNavigator.prepare({
					silentRequestTimeoutInSeconds: r,
				}),
				o = await this._signinStart(
					{
						request_type: "si:s",
						redirect_uri: s,
						prompt: "none",
			...
			try {
				let c = await this._client.processSigninResponse(o.url);
				return (
					t.debug("got signin response"),
					c.session_state && c.profile.sub
						? (t.info("success for subject", c.profile.sub),
						  {
				...
				if (this.settings.monitorAnonymousSession && c instanceof U)
					switch (c.error) {
						case "login_required":
		...
		async signoutRedirect(e = {}) {
			let t = this._logger.create("signoutRedirect"),
				...
				s = await this._redirectNavigator.prepare({
					redirectMethod: r,
				});
			...
			try {
				...
				r.debug("loaded current user from storage"),
					this.settings.revokeTokensOnSignout &&
						(await this._revokeInternal(s));
				let n = e.id_token_hint || (s && s.id_token);
				n &&
		...
		async _revokeInternal(e, t = this.settings.revokeTokenTypes) {
			...
			if (!e) return;
			let i = t.filter((s) => typeof e[s] == "string");
			if (!i.length) {
				r.debug("no need to revoke due to no token(s)");
				return;
			}
			for (let s of i)
				await this._client.revokeToken(e[s], s),
					r.info(`${s} revoked successfully`),
					s !== "access_token" && (e[s] = null);
			await this.storeUser(e),
				r.debug("user stored"),
				this._events.load(e);
		}
		startSilentRenew() {
		...
		async _loadUser() {
			...
			return t
				? (e.debug("user storageString loaded"), N.fromStorageString(t))
