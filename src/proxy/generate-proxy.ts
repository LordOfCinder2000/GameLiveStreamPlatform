...
export class Client {
	...
	abpApiDefinitionGet(
		...
		if (includeTypes === null)
			...
			url_ +=
				"IncludeTypes=" + encodeURIComponent("" + includeTypes) + "&";
		url_ = url_.replace(/[?&]$/, "");
	...
	protected processAbpApiDefinitionGet(
	...
	protected processAbpApplicationConfigurationGet(
		response: AxiosResponse
	): Promise<ApplicationConfigurationDto> {
		const status = response.status;
		let _headers: any = {};
	...
	abpTenantFindTenantByName(
		...
		let url_ =
			this.baseUrl + "/api/abp/multi-tenancy/tenants/by-name/{name}";
	...
	protected processAbpTenantFindTenantByName(
		response: AxiosResponse
	): Promise<FindTenantResultDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processAbpTenantFindTenantById(
		response: AxiosResponse
	): Promise<FindTenantResultDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processAccountRegister(
		response: AxiosResponse
	): Promise<IdentityUserDto> {
		const status = response.status;
		let _headers: any = {};
	...
	accountSendPasswordResetCode(
		body: SendPasswordResetCodeDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
	...
	protected processAccountSendPasswordResetCode(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processAccountResetPassword(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	accountRegisterWithCode(
		body: RegisteWithCodeDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<IdentityUserDto> {
		let url_ = this.baseUrl + "/api/app/account/register-with-code";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processAccountRegisterWithCode(_response);
			});
	}

	protected processAccountRegisterWithCode(
		response: AxiosResponse
	): Promise<IdentityUserDto> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	accountValidateRegisterData(
		body: RegisterDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/account/validate-register-data";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processAccountValidateRegisterData(_response);
			});
	}

	protected processAccountValidateRegisterData(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 */
	emailSendEmail(
		body: SendEmailDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/email/send-email";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processEmailSendEmail(_response);
			});
	}

	protected processEmailSendEmail(response: AxiosResponse): Promise<void> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === "object") {
			for (let k in response.headers) {
	 ...
	 * @return Success
	 */
	emailEncryptionPassword(
		password: string | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<string> {
		let url_ = this.baseUrl + "/api/app/email/encryption-password?";
		if (password === null)
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processEmailEncryptionPassword(_response);
			});
	}

	protected processEmailEncryptionPassword(
		response: AxiosResponse
	): Promise<string> {
		const status = response.status;
		let _headers: any = {};
	...
	emailSendEmailConfirmCode(
		...
		let url_ = this.baseUrl + "/api/app/email/send-email-confirm-code";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processEmailSendEmailConfirmCode(_response);
			});
	}

	protected processEmailSendEmailConfirmCode(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	emailConfirmEmailCode(
		body: ConfirmEmailCodeDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/email/confirm-email-code";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processEmailConfirmEmailCode(_response);
			});
	}

	protected processEmailConfirmEmailCode(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processEmailSettingsGet(
		response: AxiosResponse
	): Promise<EmailSettingsDto> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 */
	emailSettingsUpdate(
		body: UpdateEmailSettingsDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/setting-management/emailing";
		url_ = url_.replace(/[?&]$/, "");
	...
	protected processEmailSettingsUpdate(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	emailSettingsSendTestEmail(
		...
		let url_ =
			this.baseUrl + "/api/setting-management/emailing/send-test-email";
		url_ = url_.replace(/[?&]$/, "");
	...
	protected processEmailSettingsSendTestEmail(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	featuresUpdate(
		providerName: string | undefined,
		providerKey: string | undefined,
		body: UpdateFeaturesDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/feature-management/features?";
		if (providerName === null)
	...
	fileManagerDownload(
		...
		let url_ = this.baseUrl + "/api/app/file-manager/{id}/download";
		if (id === undefined || id === null)
			throw new Error("The parameter 'id' must be defined.");
		url_ = url_.replace("{id}", encodeURIComponent("" + id));
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processFileManagerDownload(_response);
			});
	}

	protected processFileManagerDownload(
		response: AxiosResponse
	): Promise<FileResponse> {
		const status = response.status;
		let _headers: any = {};
	...
	/**
	 * @param streamContent (optional)
	 * @return Success
	 */
	fileManagerUpload(
		id: string,
		streamContent: FileParameter | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/file-manager/{id}/upload";
		if (id === undefined || id === null)
			throw new Error("The parameter 'id' must be defined.");
		url_ = url_.replace("{id}", encodeURIComponent("" + id));
		url_ = url_.replace(/[?&]$/, "");
		...
		if (streamContent === null || streamContent === undefined)
			throw new Error("The parameter 'streamContent' cannot be null.");
		else
			content_.append(
				"streamContent",
				streamContent.data,
				streamContent.fileName
					? streamContent.fileName
					: "streamContent"
			);
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processFileManagerUpload(_response);
			});
	}

	protected processFileManagerUpload(response: AxiosResponse): Promise<void> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === "object") {
			for (let k in response.headers) {
	 ...
	 * @return Success
	 */
	fileManagerCreateFile(
		id: string | undefined,
		content: FileParameter | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/file-manager/file?";
		...
		if (content === null || content === undefined)
			...
			content_.append(
				"Content",
				content.data,
				content.fileName ? content.fileName : "Content"
			);
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processFileManagerCreateFile(_response);
			});
	}

	protected processFileManagerCreateFile(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	fileManagerCreateMultipleFile(
		id: string | undefined,
		contents: FileParameter[] | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/file-manager/multiple-file?";
		if (id === null) throw new Error("The parameter 'id' cannot be null.");
		else if (id !== undefined)
			url_ += "Id=" + encodeURIComponent("" + id) + "&";
		url_ = url_.replace(/[?&]$/, "");
		...
		if (contents === null || contents === undefined)
			throw new Error("The parameter 'contents' cannot be null.");
		else
			contents.forEach((item_) =>
				content_.append(
					"Contents",
					item_.data,
					item_.fileName ? item_.fileName : "Contents"
				)
			);
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processFileManagerCreateMultipleFile(_response);
			});
	}

	protected processFileManagerCreateMultipleFile(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	loginLogout(cancelToken?: CancelToken | undefined): Promise<void> {
	...
	protected processLoginCheckPassword(
		response: AxiosResponse
	): Promise<AbpLoginResult> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processPermissionsGet(
		response: AxiosResponse
	): Promise<GetPermissionListResultDto> {
		const status = response.status;
		let _headers: any = {};
	...
	permissionsUpdate(
		providerName: string | undefined,
		providerKey: string | undefined,
		body: UpdatePermissionsDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/permission-management/permissions?";
		if (providerName === null)
	...
	profilePatchPATCH(
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processProfilePatchPATCH(_response);
			});
	}

	protected processProfilePatchPATCH(
		response: AxiosResponse
	): Promise<ProfileDto> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	profileGet(cancelToken?: CancelToken | undefined): Promise<ProfileDto> {
		let url_ = this.baseUrl + "/api/account/my-profile";
		url_ = url_.replace(/[?&]$/, "");
	...
	protected processProfileUpdate(
		response: AxiosResponse
	): Promise<ProfileDto> {
		const status = response.status;
		let _headers: any = {};
	...
	profilePatchPUT(
		...
		let url_ = this.baseUrl + "/api/account/my-profile/property";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processProfilePatchPUT(_response);
			});
	}

	protected processProfilePatchPUT(
		response: AxiosResponse
	): Promise<ProfileDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processProfileChangePassword(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	 ...
	 * @return Success
	 */
	reCaptchaValidateReCaptcha(
		token: string | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<ReCaptchaDto> {
		let url_ = this.baseUrl + "/api/app/re-captcha/validate-re-captcha?";
		if (token === null)
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processReCaptchaValidateReCaptcha(_response);
			});
	}

	protected processReCaptchaValidateReCaptcha(
		response: AxiosResponse
	): Promise<ReCaptchaDto> {
		const status = response.status;
		let _headers: any = {};
		...
		if (status === 200) {
			...
			let result200: any = null;
			let resultData200 = _responseText;
			result200 = ReCaptchaDto.fromJS(resultData200);
			return Promise.resolve<ReCaptchaDto>(result200);
		} else if (status === 403) {
			const _responseText = response.data;
			let result403: any = null;
			let resultData403 = _responseText;
	...
	roleGetAllList(
		cancelToken?: CancelToken | undefined
	): Promise<ListResultDtoOfIdentityRoleDto> {
	...
	protected processRoleGetAllList(
		response: AxiosResponse
	): Promise<ListResultDtoOfIdentityRoleDto> {
		const status = response.status;
		let _headers: any = {};
	...
	roleGetList(
		...
		cancelToken?: CancelToken | undefined
	): Promise<PagedResultDtoOfIdentityRoleDto> {
	...
	roleUpdate(
		id: string,
		body: IdentityRoleUpdateDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<IdentityRoleDto> {
		let url_ = this.baseUrl + "/api/identity/roles/{id}";
		if (id === undefined || id === null)
	 ...
	 */
	sMSSendingSend(
		body: SMSSendingDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/app/s-mSSending/send";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processSMSSendingSend(_response);
			});
	}

	protected processSMSSendingSend(response: AxiosResponse): Promise<void> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === "object") {
			for (let k in response.headers) {
	...
	socialLinkGet(
		cancelToken?: CancelToken | undefined
	): Promise<ListResultDtoOfSocialLinkDto> {
		let url_ = this.baseUrl + "/api/account/social-link";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processSocialLinkGet(_response);
			});
	}

	protected processSocialLinkGet(
		response: AxiosResponse
	): Promise<ListResultDtoOfSocialLinkDto> {
		const status = response.status;
		let _headers: any = {};
		...
		if (status === 200) {
			...
			let result200: any = null;
			let resultData200 = _responseText;
			result200 = ListResultDtoOfSocialLinkDto.fromJS(resultData200);
			return Promise.resolve<ListResultDtoOfSocialLinkDto>(result200);
		} else if (status === 403) {
			const _responseText = response.data;
			let result403: any = null;
			let resultData403 = _responseText;
		...
		return Promise.resolve<ListResultDtoOfSocialLinkDto>(null as any);
	}
	 ...
	 */
	socialLinkCreate(
		body: CreateSocialLinkDto[] | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<ListResultDtoOfSocialLinkDto> {
		let url_ = this.baseUrl + "/api/account/social-link";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processSocialLinkCreate(_response);
			});
	}

	protected processSocialLinkCreate(
		response: AxiosResponse
	): Promise<ListResultDtoOfSocialLinkDto> {
		const status = response.status;
		let _headers: any = {};
	...
	socialLinkUpdate(
		id: string | undefined,
		body: UpdateSocialLinkDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/account/social-link?";
		if (id === null) throw new Error("The parameter 'id' cannot be null.");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processSocialLinkUpdate(_response);
			});
	}

	protected processSocialLinkUpdate(response: AxiosResponse): Promise<void> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === "object") {
			for (let k in response.headers) {
	...
	socialLinkDelete(
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processSocialLinkDelete(_response);
			});
	}

	protected processSocialLinkDelete(response: AxiosResponse): Promise<void> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && typeof response.headers === "object") {
			for (let k in response.headers) {
	...
	tenantUpdate(
		id: string,
		body: TenantUpdateDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<TenantDto> {
		let url_ = this.baseUrl + "/api/multi-tenancy/tenants/{id}";
		if (id === undefined || id === null)
	...
	protected processTenantGetList(
		response: AxiosResponse
	): Promise<PagedResultDtoOfTenantDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processTenantGetDefaultConnectionString(
		response: AxiosResponse
	): Promise<string> {
		const status = response.status;
		let _headers: any = {};
	...
	tenantUpdateDefaultConnectionString(
		...
		if (defaultConnectionString === null)
			throw new Error(
				"The parameter 'defaultConnectionString' cannot be null."
			);
		else if (defaultConnectionString !== undefined)
			url_ +=
				"defaultConnectionString=" +
				encodeURIComponent("" + defaultConnectionString) +
				"&";
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processTenantUpdateDefaultConnectionString(
					_response
				);
			});
	}

	protected processTenantUpdateDefaultConnectionString(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	tenantDeleteDefaultConnectionString(
		...
		return this.instance
			...
			.then((_response: AxiosResponse) => {
				return this.processTenantDeleteDefaultConnectionString(
					_response
				);
			});
	}

	protected processTenantDeleteDefaultConnectionString(
		response: AxiosResponse
	): Promise<void> {
		const status = response.status;
		let _headers: any = {};
	...
	userUpdate(
		id: string,
		body: IdentityUserUpdateDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<IdentityUserDto> {
		let url_ = this.baseUrl + "/api/identity/users/{id}";
		if (id === undefined || id === null)
	...
	userGetList(
		...
		maxResultCount: number | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<PagedResultDtoOfIdentityUserDto> {
	...
	userUpdateRoles(
		id: string,
		body: IdentityUserUpdateRolesDto | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<void> {
		let url_ = this.baseUrl + "/api/identity/users/{id}/roles";
		if (id === undefined || id === null)
	...
	protected processUserGetAssignableRoles(
		response: AxiosResponse
	): Promise<ListResultDtoOfIdentityRoleDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processUserFindByUsername(
		response: AxiosResponse
	): Promise<IdentityUserDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processUserFindByEmail(
		response: AxiosResponse
	): Promise<IdentityUserDto> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processUserLookupFindById(
		response: AxiosResponse
	): Promise<UserData> {
		const status = response.status;
		let _headers: any = {};
	...
	userLookupFindByUserName(
		...
		let url_ =
			this.baseUrl + "/api/identity/users/lookup/by-username/{userName}";
		if (userName === undefined || userName === null)
			throw new Error("The parameter 'userName' must be defined.");
		url_ = url_.replace("{userName}", encodeURIComponent("" + userName));
		url_ = url_.replace(/[?&]$/, "");
	...
	protected processUserLookupFindByUserName(
		response: AxiosResponse
	): Promise<UserData> {
		const status = response.status;
		let _headers: any = {};
	...
	userLookupSearch(
		...
		maxResultCount: number | undefined,
		cancelToken?: CancelToken | undefined
	): Promise<ListResultDtoOfUserData> {
	...
	protected processUserLookupSearch(
		response: AxiosResponse
	): Promise<ListResultDtoOfUserData> {
		const status = response.status;
		let _headers: any = {};
	...
	protected processUserLookupGetCount(
		response: AxiosResponse
	): Promise<number> {
		const status = response.status;
		let _headers: any = {};
		...
		if (_data) {
			...
			if (Array.isArray(_data["parametersOnMethod"])) {
				...
				for (let item of _data["parametersOnMethod"])
					this.parametersOnMethod!.push(
						MethodParameterApiDescriptionModel.fromJS(item)
					);
			}
			if (Array.isArray(_data["parameters"])) {
				...
				for (let item of _data["parameters"])
					this.parameters!.push(
						ParameterApiDescriptionModel.fromJS(item)
					);
			}
...
export class ApplicationApiDescriptionModel
	implements IApplicationApiDescriptionModel
{
				...
				for (let key in _data["modules"]) {
					if (_data["modules"].hasOwnProperty(key))
						(<any>this.modules)![key] = _data["modules"][key]
							? ModuleApiDescriptionModel.fromJS(
									_data["modules"][key]
							  )
				...
				for (let key in _data["types"]) {
					if (_data["types"].hasOwnProperty(key))
						(<any>this.types)![key] = _data["types"][key]
							? TypeApiDescriptionModel.fromJS(
									_data["types"][key]
							  )
		...
		if (this.types) {
			...
			for (let key in this.types) {
				if (this.types.hasOwnProperty(key))
					(<any>data["types"])[key] = this.types[key]
						? this.types[key].toJSON()
						: <any>undefined;
			}
		}
		return data;
...
export class ApplicationAuthConfigurationDto
	implements IApplicationAuthConfigurationDto
{
			...
			if (_data["grantedPolicies"]) {
				...
				for (let key in _data["grantedPolicies"]) {
					if (_data["grantedPolicies"].hasOwnProperty(key))
						(<any>this.grantedPolicies)![key] =
							_data["grantedPolicies"][key];
				}
			}
		}
	}
		...
		if (this.grantedPolicies) {
			...
			for (let key in this.grantedPolicies) {
				if (this.grantedPolicies.hasOwnProperty(key))
					(<any>data["grantedPolicies"])[key] = (<any>(
	...
	implements IApplicationConfigurationDto
{
	...
	init(_data?: any) {
		if (_data) {
			this.localization = _data["localization"]
				? ApplicationLocalizationConfigurationDto.fromJS(
						_data["localization"]
				  )
				: <any>undefined;
			...
			this.globalFeatures = _data["globalFeatures"]
				? ApplicationGlobalFeatureConfigurationDto.fromJS(
						_data["globalFeatures"]
				  )
				: <any>undefined;
			...
			this.timing = _data["timing"]
				? TimingDto.fromJS(_data["timing"])
				: <any>undefined;
			this.clock = _data["clock"]
				? ClockDto.fromJS(_data["clock"])
				: <any>undefined;
			...
			if (_data["extraProperties"]) {
				...
				for (let key in _data["extraProperties"]) {
					if (_data["extraProperties"].hasOwnProperty(key))
						(<any>this.extraProperties)![key] =
							_data["extraProperties"][key];
				}
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		data["features"] = this.features
			...
			: <any>undefined;
		data["globalFeatures"] = this.globalFeatures
			? this.globalFeatures.toJSON()
			: <any>undefined;
		data["multiTenancy"] = this.multiTenancy
			? this.multiTenancy.toJSON()
			: <any>undefined;
		data["currentTenant"] = this.currentTenant
			? this.currentTenant.toJSON()
			: <any>undefined;
		...
		if (this.extraProperties) {
			...
			for (let key in this.extraProperties) {
				if (this.extraProperties.hasOwnProperty(key))
					(<any>data["extraProperties"])[key] = (<any>(
...
export class ApplicationFeatureConfigurationDto
	implements IApplicationFeatureConfigurationDto
{
			...
			if (_data["languagesMap"]) {
				...
				for (let key in _data["languagesMap"]) {
					if (_data["languagesMap"].hasOwnProperty(key))
						(<any>this.languagesMap)![key] = _data["languagesMap"][
							key
						]
							? _data["languagesMap"][key].map((i: any) =>
									NameValue.fromJS(i)
							  )
							: <any>undefined;
				}
			...
			if (_data["languageFilesMap"]) {
				...
				for (let key in _data["languageFilesMap"]) {
					if (_data["languageFilesMap"].hasOwnProperty(key))
						(<any>this.languageFilesMap)![key] = _data[
							"languageFilesMap"
						][key]
		...
		if (this.languagesMap) {
			...
			for (let key in this.languagesMap) {
				if (this.languagesMap.hasOwnProperty(key))
					(<any>data["languagesMap"])[key] = (<any>this.languagesMap)[
						key
					];
			}
		}
		if (this.languageFilesMap) {
			...
			for (let key in this.languageFilesMap) {
				if (this.languageFilesMap.hasOwnProperty(key))
					(<any>data["languageFilesMap"])[key] = (<any>(
...
export class ApplicationSettingConfigurationDto
	implements IApplicationSettingConfigurationDto
{
	values?: { [key: string]: string } | undefined;
...
export class ConfirmEmailCodeDto implements IConfirmEmailCodeDto {
	emailAddress!: string;
	code!: string;

	constructor(data?: IConfirmEmailCodeDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	static fromJS(data: any): ConfirmEmailCodeDto {
		data = typeof data === "object" ? data : {};
		let result = new ConfirmEmailCodeDto();
		result.init(data);
		return result;
	}
...
export interface IConfirmEmailCodeDto {
	emailAddress: string;
	code: string;
}

export class ControllerApiDescriptionModel
	implements IControllerApiDescriptionModel
{
			...
			if (Array.isArray(_data["interfaces"])) {
				...
				for (let item of _data["interfaces"])
					this.interfaces!.push(
						ControllerInterfaceApiDescriptionModel.fromJS(item)
					);
			}
			if (_data["actions"]) {
				this.actions = {} as any;
				for (let key in _data["actions"]) {
					if (_data["actions"].hasOwnProperty(key))
						(<any>this.actions)![key] = _data["actions"][key]
							? ActionApiDescriptionModel.fromJS(
									_data["actions"][key]
							  )
...
export class CreateSocialLinkDto implements ICreateSocialLinkDto {
	url!: string;
	socialName!: SocialLinkType;

	constructor(data?: ICreateSocialLinkDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	static fromJS(data: any): CreateSocialLinkDto {
		data = typeof data === "object" ? data : {};
		let result = new CreateSocialLinkDto();
		result.init(data);
		return result;
	}
...
export interface ICreateSocialLinkDto {
	url: string;
	socialName: SocialLinkType;
}
	...
	init(_data?: any) {
		if (_data) {
			...
			this.threeLetterIsoLanguageName =
				_data["threeLetterIsoLanguageName"];
				...
				for (let key in _data["properties"]) {
					if (_data["properties"].hasOwnProperty(key))
						(<any>this.properties)![key] = _data["properties"][key]
							? ExtensionPropertyDto.fromJS(
									_data["properties"][key]
							  )
			...
			if (_data["configuration"]) {
				...
				for (let key in _data["configuration"]) {
					if (_data["configuration"].hasOwnProperty(key))
						(<any>this.configuration)![key] =
							_data["configuration"][key];
				}
			}
		}
	}
		...
		if (this.configuration) {
			...
			for (let key in this.configuration) {
				if (this.configuration.hasOwnProperty(key))
					(<any>data["configuration"])[key] = (<any>(
						this.configuration
					))[key];
			}
		}
...
export class ExtensionPropertyApiCreateDto
	implements IExtensionPropertyApiCreateDto
{
	isAvailable?: boolean;
...
export class ExtensionPropertyApiDto implements IExtensionPropertyApiDto {
	...
	toJSON(data?: any) {
		...
		data["onCreate"] = this.onCreate
			? this.onCreate.toJSON()
			: <any>undefined;
		data["onUpdate"] = this.onUpdate
			? this.onUpdate.toJSON()
			: <any>undefined;
		return data;
	}
}
...
export class ExtensionPropertyApiUpdateDto
	implements IExtensionPropertyApiUpdateDto
{
	isAvailable?: boolean;
...
export class ExtensionPropertyAttributeDto
	implements IExtensionPropertyAttributeDto
{
	...
	init(_data?: any) {
		if (_data) {
			...
			this.displayName = _data["displayName"]
				...
				: <any>undefined;
			this.api = _data["api"]
				? ExtensionPropertyApiDto.fromJS(_data["api"])
				: <any>undefined;
			this.ui = _data["ui"]
				? ExtensionPropertyUiDto.fromJS(_data["ui"])
				: <any>undefined;
			if (Array.isArray(_data["attributes"])) {
				this.attributes = [] as any;
				for (let item of _data["attributes"])
					this.attributes!.push(
						ExtensionPropertyAttributeDto.fromJS(item)
					);
			}
			if (_data["configuration"]) {
				this.configuration = {} as any;
...
export class ExtensionPropertyUiDto implements IExtensionPropertyUiDto {
	...
	toJSON(data?: any) {
		...
		data["onCreateForm"] = this.onCreateForm
			? this.onCreateForm.toJSON()
			: <any>undefined;
		data["onEditForm"] = this.onEditForm
			? this.onEditForm.toJSON()
			: <any>undefined;
...
export class ExtensionPropertyUiLookupDto
	implements IExtensionPropertyUiLookupDto
{
	url?: string | undefined;
...
export class ExtensionPropertyUiTableDto
	implements IExtensionPropertyUiTableDto
{
	isVisible?: boolean;
...
export class FeatureDto implements IFeatureDto {
	...
	init(_data?: any) {
		if (_data) {
			...
			this.provider = _data["provider"]
				? FeatureProviderDto.fromJS(_data["provider"])
				: <any>undefined;
			this.description = _data["description"];
			this.valueType = _data["valueType"]
				? IStringValueType.fromJS(_data["valueType"])
				: <any>undefined;
	...
	toJSON(data?: any) {
		...
		data["provider"] = this.provider
			? this.provider.toJSON()
			: <any>undefined;
		data["description"] = this.description;
		data["valueType"] = this.valueType
			? this.valueType.toJSON()
			: <any>undefined;
...
export class IStringValueType implements IIStringValueType {
	...
	toJSON(data?: any) {
		...
		if (this.properties) {
			...
			for (let key in this.properties) {
				if (this.properties.hasOwnProperty(key))
					(<any>data["properties"])[key] = (<any>this.properties)[
						key
					];
			}
		}
	...
	init(_data?: any) {
		if (_data) {
			if (_data["extraProperties"]) {
				...
				for (let key in _data["extraProperties"]) {
					if (_data["extraProperties"].hasOwnProperty(key))
						(<any>(<any>this).extraProperties)![key] =
							_data["extraProperties"][key];
				}
			}
			this.name = _data["name"];
	...
	init(_data?: any) {
		if (_data) {
			...
			this.deletionTime = _data["deletionTime"]
				? new Date(_data["deletionTime"].toString())
				: <any>undefined;
			this.tenantId = _data["tenantId"];
			this.userName = _data["userName"];
			this.name = _data["name"];
...
export class ListResultDtoOfIdentityRoleDto
	implements IListResultDtoOfIdentityRoleDto
{
...
export class ListResultDtoOfSocialLinkDto
	implements IListResultDtoOfSocialLinkDto
{
	items?: SocialLinkDto[] | undefined;

	constructor(data?: IListResultDtoOfSocialLinkDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	init(_data?: any) {
		if (_data) {
			if (Array.isArray(_data["items"])) {
				this.items = [] as any;
				for (let item of _data["items"])
					this.items!.push(SocialLinkDto.fromJS(item));
			}
		}
	}

	static fromJS(data: any): ListResultDtoOfSocialLinkDto {
		data = typeof data === "object" ? data : {};
		let result = new ListResultDtoOfSocialLinkDto();
		result.init(data);
		return result;
	}
...
export interface IListResultDtoOfSocialLinkDto {
	items?: SocialLinkDto[] | undefined;
}
...
export class MethodParameterApiDescriptionModel
	implements IMethodParameterApiDescriptionModel
{
	name?: string | undefined;
			...
			if (_data["controllers"]) {
				...
				for (let key in _data["controllers"]) {
					if (_data["controllers"].hasOwnProperty(key))
						(<any>this.controllers)![key] = _data["controllers"][
							key
						]
							? ControllerApiDescriptionModel.fromJS(
									_data["controllers"][key]
							  )
		...
		if (this.enums) {
			...
			for (let key in this.enums) {
				if (this.enums.hasOwnProperty(key))
					(<any>data["enums"])[key] = this.enums[key]
						? this.enums[key].toJSON()
						: <any>undefined;
			}
		}
		return data;
...
export class PagedResultDtoOfIdentityRoleDto
	implements IPagedResultDtoOfIdentityRoleDto
{
	items?: IdentityRoleDto[] | undefined;
	totalCount?: number;
...
export class PagedResultDtoOfIdentityUserDto
	implements IPagedResultDtoOfIdentityUserDto
{
...
export class ParameterApiDescriptionModel
	implements IParameterApiDescriptionModel
{
...
export class PropertyApiDescriptionModel
	implements IPropertyApiDescriptionModel
{
	name?: string | undefined;
	jsonName?: string | undefined;
	type?: string | undefined;
...
export class ReCaptchaDto implements IReCaptchaDto {
	success?: boolean;
	challengeTs?: Date | undefined;
	hotName?: string | undefined;

	constructor(data?: IReCaptchaDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	init(_data?: any) {
		if (_data) {
			this.success = _data["success"];
			this.challengeTs = _data["challengeTs"]
				? new Date(_data["challengeTs"].toString())
				: <any>undefined;
			this.hotName = _data["hotName"];
		}
	}

	static fromJS(data: any): ReCaptchaDto {
		data = typeof data === "object" ? data : {};
		let result = new ReCaptchaDto();
		result.init(data);
		return result;
	}
	...
	toJSON(data?: any) {
		data = typeof data === "object" ? data : {};
		data["success"] = this.success;
		data["challengeTs"] = this.challengeTs
			? this.challengeTs.toISOString()
			: <any>undefined;
		data["hotName"] = this.hotName;
		return data;
	}
}
...
export class RegisteWithCodeDto implements IRegisteWithCodeDto {
	register!: RegisterDto;
	code!: string;

	constructor(data?: IRegisteWithCodeDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	init(_data?: any) {
		if (_data) {
			this.register = _data["register"]
				? RegisterDto.fromJS(_data["register"])
				: new RegisterDto();
			this.code = _data["code"];
		}
	}

	static fromJS(data: any): RegisteWithCodeDto {
		data = typeof data === "object" ? data : {};
		let result = new RegisteWithCodeDto();
		result.init(data);
		return result;
	}
...
export interface IRegisteWithCodeDto {
	register: RegisterDto;
	code: string;
}
			...
			if (Array.isArray(_data["validationErrors"])) {
				...
				for (let item of _data["validationErrors"])
					this.validationErrors!.push(
						RemoteServiceValidationErrorInfo.fromJS(item)
					);
			}
		}
	}
	...
	init(_data?: any) {
		if (_data) {
			this.error = _data["error"]
				? RemoteServiceErrorInfo.fromJS(_data["error"])
				: <any>undefined;
		}
	}
...
export class RemoteServiceValidationErrorInfo
	implements IRemoteServiceValidationErrorInfo
{
	message?: string | undefined;
...
export class ReturnValueApiDescriptionModel
	implements IReturnValueApiDescriptionModel
{
	type?: string | undefined;
	typeSimple?: string | undefined;
...
export class SMSSendingDto implements ISMSSendingDto {
	phone!: string;
	content!: string;

	constructor(data?: ISMSSendingDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	static fromJS(data: any): SMSSendingDto {
		data = typeof data === "object" ? data : {};
		let result = new SMSSendingDto();
		result.init(data);
		return result;
	}
...
export interface ISMSSendingDto {
	phone: string;
	content: string;
}
	...
	init(_data?: any) {
		if (_data) {
			this.iana = _data["iana"]
				? IanaTimeZone.fromJS(_data["iana"])
				: <any>undefined;
			this.windows = _data["windows"]
				? WindowsTimeZone.fromJS(_data["windows"])
				: <any>undefined;
		}
	}
	...
	init(_data?: any) {
		if (_data) {
			this.timeZone = _data["timeZone"]
				? TimeZone.fromJS(_data["timeZone"])
				: <any>undefined;
		}
	}
			...
			if (Array.isArray(_data["properties"])) {
				...
				for (let item of _data["properties"])
					this.properties!.push(
						PropertyApiDescriptionModel.fromJS(item)
					);
			}
		}
	}
...
export class UpdateSocialLinkDto implements IUpdateSocialLinkDto {
	url!: string;

	constructor(data?: IUpdateSocialLinkDto) {
		if (data) {
			for (var property in data) {
				if (data.hasOwnProperty(property))
					(<any>this)[property] = (<any>data)[property];
	...
	static fromJS(data: any): UpdateSocialLinkDto {
		data = typeof data === "object" ? data : {};
		let result = new UpdateSocialLinkDto();
		result.init(data);
		return result;
	}
...
export interface IUpdateSocialLinkDto {
	url: string;
}
